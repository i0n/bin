" Vim color file
" Maintainer:  Ian Alexander Wood 
" Last Change: 10th March 2011 
"
" mutant-wombat256.vim - a modified version of Wombat by Lars Nielsen that also
...
let g:colors_name = "mutant-wombat256"
...
call <SID>X("StatusLineNC",	"990099",	"000000",	"none")
			"Scrollbar
			"Tooltip
			"Menu
			"WildMenu
...
if has("autocmd")
	...
	silent! au InsertLeave * hi StatusLine guibg=green  
